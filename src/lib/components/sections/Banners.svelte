<script lang="ts">
  ...
  let { banners = [] as BannerItem[] } = $props();
    ...
    >
      ...
      {#if slides.length > 1}
        <button
          ...
          class="absolute left-3 top-1/2 -translate-y-1/2 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center backdrop-blur-md bg-black/40 border border-white/15 text-white/80 hover:bg-black/65 hover:text-white hover:scale-105 active:scale-95 transition-all duration-200"
          style="z-index: 20;"
        ...
        <button
          ...
          class="absolute right-12 top-1/2 -translate-y-1/2 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center backdrop-blur-md bg-black/40 border border-white/15 text-white/80 hover:bg-black/65 hover:text-white hover:scale-105 active:scale-95 transition-all duration-200"
          style="z-index: 20;"
