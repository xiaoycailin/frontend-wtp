            ...
            >
              ...
              <div class="p-3">
                <div class="flex items-center gap-2 mb-2">
                  ...
                  <div>
                    <p class="text-[11px] font-bold text-white leading-tight">{p.label}</p>
        ...
        {#each specialItems as p}
          ...
          >
            <div
              ...
              style="background:{isSelected ? 'rgba(245,197,24,0.15)' : 'rgba(255,255,255,0.05)'};"
            >
              <img src={p.icon} width="25" alt="" />
            </div>
...
<style>
  ...
  .product-card {
    ...
    text-align: left; transition: all 0.2s; overflow: hidden;
  }
  .check-badge {
