...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between">
    <div>
      ...
      <p class="text-sm text-white/50 mt-1">
        Kelola konten artikel dan blog website
      </p>
    </div>
    <button
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
    <div class="bg-[#0b0b0b] border border-white/5 rounded-xl p-5">
      <div class="flex items-center justify-between">
        ...
        <div
          class="w-12 h-12 rounded-lg bg-[#f5c518]/15 flex items-center justify-center"
        >
          <svg
            class="w-6 h-6 text-[#f5c518]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
    ...
    <div class="bg-[#0b0b0b] border border-white/5 rounded-xl p-5">
      <div class="flex items-center justify-between">
        ...
        <div
          class="w-12 h-12 rounded-lg bg-green-500/15 flex items-center justify-center"
        >
          <svg
    ...
    <div class="bg-[#0b0b0b] border border-white/5 rounded-xl p-5">
      <div class="flex items-center justify-between">
        ...
        <div
          class="w-12 h-12 rounded-lg bg-yellow-500/15 flex items-center justify-center"
        >
          <svg
    ...
    <div class="bg-[#0b0b0b] border border-white/5 rounded-xl p-5">
      <div class="flex items-center justify-between">
        ...
        <div
          class="w-12 h-12 rounded-lg bg-blue-500/15 flex items-center justify-center"
        >
          <svg
  ...
  <div class="bg-[#0b0b0b] border border-white/5 rounded-xl overflow-hidden">
          ...
          {:else}
            {#each articles as article}
              ...
              <tr class="hover:bg-white/5 transition-colors">
                <td class="px-4 py-4">
                  <div class="space-y-1">
                    <p class="text-sm font-medium text-white truncate max-w-xs">
                      {article.title}
                    </p>
                ...
                <td class="px-4 py-4">
                  <span
                    class={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${statusBadge.color}`}
                  >
                    {statusBadge.label}
                  </span>
                </td>
    ...
    {#if !loading && total > 0}
      <div
        class="px-4 py-3 border-t border-white/5 flex items-center justify-between"
      >
